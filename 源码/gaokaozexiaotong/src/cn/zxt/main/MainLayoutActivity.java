...
import cn.zxt.main.MainLayoutActivity.SpinnerSelectedListener;
import cn.zxt.query.Query2;
import cn.zxt.query.QueryLayout;
...
public class MainLayoutActivity extends Activity implements OnClickListener {
	...
	private void scorequery() {
		...
		Intent intent = new Intent(MainLayoutActivity.this, Query2.class);
