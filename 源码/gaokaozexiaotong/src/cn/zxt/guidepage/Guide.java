...
import cn.zxt.main.MainActivity;
...
public class Guide extends Activity implements OnPageChangeListener {
	...
	private void initViews() {
		...
		views.add(inflater.inflate(R.layout.yindao1, null));
		views.add(inflater.inflate(R.layout.yindao2, null));
		views.add(inflater.inflate(R.layout.yindao3, null));
